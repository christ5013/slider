...
def display_text(temp):
    clue_data[0].text = "Accel: {} {} {} m/s^2".format(temp["slider/xaccelerometer"] , temp["slider/yaccelerometer"], temp["slider/zaccelerometer"])
    ...
    clue_data[3].text = "Pressure: {} hPa".format(temp["pressure"])
    ...
    clue_data[8].text = "Color: R: {} G: {} B: {} C: {}".format(temp["slider/red"], temp["slider/green"], temp["slider/blue"])
    clue_data.show()

sensor = {
    "slider/xaccelerometer" :0
    "slider/yaccelerometer" : 0
